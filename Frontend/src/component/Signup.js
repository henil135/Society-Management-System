...
export default function Signup() {
    ...
    return (
        <div className="d-flex flex-column flex-md-row min-vh-100 position-relative">
            {/* Left Side: Image */}
            <div className="signup-img w-100 w-md-50 d-flex flex-column align-items-left">
            ...
            {/* Right Side: Form */}
            <div className="signup-form w-100 w-md-50  d-flex align-items-center justify-content-center py-5" style={{ opacity: showForm ? 0.6 : 1 }}>
                <div className="form bg-white p-4 rounded shadow">
                    ...
                    <form onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <p className='text-center'>Already have an account? <Link className='text-danger text-decoration-none'>Login</Link></p>
