...
import { FaUser, FaHome, FaTag, FaEye, FaEdit } from 'react-icons/fa'; // Using react-icons as placeholders
        ...
        <div className="container-fluid bg-white rounded shadow-sm p-4" style={{ marginTop: "70px" }}>
          <div className="d-flex flex-column flex-md-row justify-content-between align-items-center mb-4">
            ...
            <Link to="/home/addresidents">
              <Button className="mainColor2 mt-3 mt-md-0">Add New Resident Details</Button>
            </Link>
          </div>
          ...
          <div className="table-responsive">
            <table className="table striped hover responsive">
              <thead>
                <tr className="rmHead">
                  <th className="text-center" style={{ padding: "10px", width: "200px" }}>Full Name</th>
                  <th className="text-center" style={{ padding: "10px", width: "150px" }}>Unit Number</th>
                  <th className="text-center" style={{ padding: "10px", width: "150px" }}>Unit Status</th>
                  <th className="text-center" style={{ padding: "10px", width: "150px" }}>Resident Status</th>
                  <th className="text-center" style={{ padding: "10px", width: "150px" }}>Phone Number</th>
                  <th className="text-center" style={{ padding: "10px", width: "130px" }}>Members</th>
                  <th className="text-center" style={{ padding: "10px", width: "130px" }}>Vehicle</th>
                  <th className="text-center" style={{ padding: "10px", width: "150px" }}>Action</th>
                </tr>
              </thead>
              <tbody>
