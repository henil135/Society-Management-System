  ...
  <div className="flex-grow-1 p-4">
    <div className="container-fluid bg-white rounded shadow-sm p-2" style={{ marginTop: "70px" }}>
      <div className="d-flex flex-column flex-md-row justify-content-between align-items-center mb-4">
        ...
        <Button className="btn mainColor2" onClick={handleShowCreateModal}>Create Request</Button>
      </div>

      <div className="table-responsive" style={{ border: "1px solid #ddd", borderRadius: "8px", boxShadow: "0px 0px 15px rgba(0, 0, 0, 0.1)", overflow: "hidden", backgroundColor: "#fff", marginTop: "20px" }}>
        <Table striped hover responsive className="mt-3" style={{ width: "100%" }}>
          <thead className="bg-light">
            <tr className="rmHead">
              <th className="text-start" style={{ padding: "5px",fontSize:"14px",paddingLeft:"20px" }}>Requester Name</th>
              <th className="text-center" style={{ padding: "5px",fontSize:"14px" }}>Request Name</th>
              <th className="text-center" style={{ padding: "5px",fontSize:"14px" }}>Description</th>
              <th className="text-center" style={{ padding: "5px",fontSize:"14px" }}>Request Date</th>
              <th className="text-center" style={{ padding: "5px",fontSize:"14px" }}>Unit Number</th>
              <th className="text-center" style={{ padding: "5px",fontSize:"14px" }}>Priority</th>
              <th className="text-center" style={{ padding: "5px",fontSize:"14px" }}>Status</th>
              <th className="text-center" style={{ padding: "5px",fontSize:"14px" }}>Actions</th>
            </tr>
          </thead>
          <tbody>
