...
export default function FinancialManagementIncome() {
  ...
  const handleShowAddMaintenanceModal = () => setShowAddMaintenanceModal(true);
          ...
          <div className='row p-3'>
            <div className='bg-light d-flex justify-content-between align-items-center'>
              ...
              <div className='d-flex'>
                <div className='col-lg-3 py-3 position-relative px-1' style={{ width: '236px' }}>
              ...
              <div>
                <button className='set-maintainance-btn' onClick={handleShowSetMaintenanceModal}>Set Maintenance</button>
              </div>
          ...
          <div className='row ps-3 pe-2 '>
            <div className='py-0 px-1'>
              <div className="table-responsive rounded pb-3">
                ...
                <Link className='btn btn-sm  maintainance-income-btn' activeClassName="active-btn" exact>Maintenance</Link>

                <Link className='btn btn-sm  maintainance-income-btn' activeClassName="active-btn" exact>Other Income</Link>
