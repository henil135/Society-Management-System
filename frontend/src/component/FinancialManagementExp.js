...
export default function FinancialManagementExp() {
  ...
  const [exp, setExp] = useState([
    ...
    { title: 'Rent or Mortgage', des: 'A visual representation of your spending categories...', date: '10/02/2024', amt: '₹ 1000', format: 'PDF' },
  ])
                          ...
                          exp.map((val, index) => {
                            return (
                              <tr key={index} className='bg-light'>
                                ...
                                <td style={{ height: '55px' }} className='financial-Pnumber'>{val.amt}</td>
